...
- `MLFLOW_TRACKING_URI` (optional): URL of the MLflow tracking server (e.g. `http://localhost:5000`). If set, the service will attempt to load a registered model from the registry.
